...
class HomePage extends StatelessWidget {
  ...
  Widget appleList() {
    return ListView(
      children: [
        DisplayItem(name: 'Sweet Apple Indonesia', price: 'Rp 25.000', image_path: 'assets/images/apple.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Apple Canada', price: 'Rp 15.000', image_path: 'assets/images/apple.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Apple Japan', price: 'Rp 20.000', image_path: 'assets/images/apple.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Apple India', price: 'Rp 25.000', image_path: 'assets/images/apple.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Apple Namibia', price: 'Rp 5.000', image_path: 'assets/images/apple.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Apple America', price: 'Rp 35.000', image_path: 'assets/images/apple.png'),
      ],
    );
  }
  ...
  Widget orangeList() {
    return ListView(
      children: [
        DisplayItem(name: 'Sweet Orange Indonesia', price: 'Rp 25.000', image_path: 'assets/images/orange.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Orange Canada', price: 'Rp 15.000', image_path: 'assets/images/orange.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Orange Japan', price: 'Rp 20.000', image_path: 'assets/images/orange.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Orange India', price: 'Rp 25.000', image_path: 'assets/images/orange.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Orange Namibia', price: 'Rp 5.000', image_path: 'assets/images/orange.png'),
        const SizedBox(height: 8),
      ],
    );
  }
  ...
  Widget bananaList() {
    return ListView(
      children: [
        DisplayItem(name: 'Sweet Banana Italia', price: 'Rp 25.000', image_path: 'assets/images/bananas.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Banana Arabic', price: 'Rp 15.000', image_path: 'assets/images/bananas.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Banana Japan', price: 'Rp 20.000', image_path: 'assets/images/bananas.png'),
        const SizedBox(height: 8),
        DisplayItem(name: 'Sweet Banana Africa', price: 'Rp 25.000', image_path: 'assets/images/bananas.png'),
        const SizedBox(height: 8),
      ],
    );
  }
